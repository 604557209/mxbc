	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="updateCusAction.action?f_area=4" method="post">
	...
	<nav class="navbar navbar-default" style="margin-top:2%;height:auto">
		<div class="container-fluid" style="height:auto">
			<div class="main" style="height:auto">
				<h2 class="sub-header">华北客户信息列表</h2>
						...
						<tbody>
							<tr>
								...
								<td align="right" height="25">
									...
									<div class="btn-group" role="group">
										<button type="button" class="btn btn-default" onclick="location='findByAreaCusAction.action?c_area=4&pageNo=${pageModel.previousPageNo}'">上一页</button>
										<button type="button" class="btn btn-default" onclick="location='findByAreaCusAction.action?c_area=4&pageNo=${pageModel.nextPageNo}'">下一页</button>
										<button type="button" class="btn btn-default" onclick="location='findByAreaCusAction.action?c_area=4&pageNo=${pageModel.topPageNo}'">首页</button>
										<button type="button" class="btn btn-default" onclick="location='findByAreaCusAction.action?c_area=4&pageNo=${pageModel.bottomPageNo}'">末页</button>
									</div>
								</td>
							</tr>
						</tbody>
